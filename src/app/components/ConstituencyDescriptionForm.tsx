...
interface ConstituencyDescriptionFormProps {
  value: string;
  onChange: (value: string) => void;
}

export function ConstituencyDescriptionForm({ value, onChange }: ConstituencyDescriptionFormProps) {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-900 mb-2">Describe Your Constituency</h2>
      <p className="text-gray-600 mb-6">
        Help others understand the district you represent. What are the key issues, demographics, and characteristics of your constituency?
      </p>
      ...
      <div className="space-y-4">
        <div>
          <textarea
            ...
            placeholder="My constituency is characterized by..."
        ...
        {wordCount > maxWords && (
          <div className="text-sm text-red-600 bg-red-50 border border-red-200 rounded-md px-4 py-2">
            Please reduce your description to {maxWords} words or fewer (currently {wordCount})
          </div>
        )}
        ...
        {wordCount >= minWords && wordCount <= maxWords && (
          <div className="text-sm text-green-600 bg-green-50 border border-green-200 rounded-md px-4 py-2">
            Excellent! Your constituency description meets the requirements.
          </div>
        )}
      </div>
    </div>
